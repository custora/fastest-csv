...
class TestFastestCSVInterface < Minitest::Test
  ...
  def test_invalid_grammar
    assert_raises RuntimeError do
      FastestCSV.foreach(@path_basic, row_sep: "A") do |_row|
      end
    end

    assert_raises RuntimeError do
      FastestCSV.foreach(@path_basic, col_sep: ",", quote_char: ",") do |_row|
      end
    end

    assert_raises RuntimeError do
      FastestCSV.foreach(@path_basic, col_sep: ",,") do |_row|
      end
    end

    assert_raises RuntimeError do
      FastestCSV.foreach(@path_basic, grammar: "not-strict-or-relaxed") do |_row|
      end
    end
  end
  ...
  def test_check_field_count
    ...
    assert_raises RuntimeError do
      FastestCSV.foreach(@path_basic, check_field_count: true) do |_row|
      end
    end
